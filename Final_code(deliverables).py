...
class Login:
    ...
    def __init__(self,root):
        ...
        #=====BG Image======
        self.bg=PhotoImage(file="C:\\Users\\Lakshya Narula\\Desktop\\loginbackground.png")
    ...
    def login_function(self):
        if self.txt_pass.get()=="" or self.txt_user.get()=="":
            ...
            if response=="yes":
                #=======BK Image===========
                self.bk=PhotoImage(file="C:\\Users\\Lakshya Narula\\Desktop\\Screenshot (188).png")
    ...
    def notes(self):
        self.bw=PhotoImage(file="C:\\Users\\Lakshya Narula\\Desktop\\BackgroundNotes.png")
    ...
    def chatscreen(self):
        self.br=PhotoImage(file="C:\\Users\\Lakshya Narula\\Desktop\\Screenshot (190).png")
